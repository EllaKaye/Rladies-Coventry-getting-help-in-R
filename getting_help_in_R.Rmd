...
meta() %>%
  ...
  meta_social(
    title = "Getting Help in R",
    url = "https://ellakaye.rbind.io/talk/2020-10-20-rladies-coventry-getting-help/",
    image = "https://github.com/EllaKaye/Rladies-Coventry-getting-help-in-R/blob/main/logo.svg",
