...
.bit-large[Ella Kaye | Rladies Coventry | October 29th, 2020]
...
- Source code
  ...
  - `function_name` to see source code (no brackets)
...
- Answer questions on StackOverflow [[r]](https://stackoverflow.com/questions/tagged/r) and twitter ([#rstats](https://twitter.com/hashtag/rstats))
...
.large[
`r icon::fa('link')` [bit.ly/emk-getting-help-R](http://bit.ly/emk-getting-help-R)
